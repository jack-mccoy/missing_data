...
# outputs to ../output/bcsignals/bcsignals_none.csv
...
option_list <- list(
  ...
  optparse::make_option(c("--impute_vec"),
                        type = "character", default = "../data/signals_best157.txt",
                        help = "a comma-separated list of values or .txt file to scan, by default all 157 continuous and gapless")
)
...
fwrite(bctrans, '../output/bcsignals/bcsignals_none.csv')
